...
- 🚀 **LC Problem Reminder**  
  Chrome extension to help stay consistent with LeetCode practice through reminders and tracking.  
  https://chromewebstore.google.com/detail/gfodgdebhllgabeegdfoaoeidjnghdpp/

- 📊 **Skill Tracker - Confidence Dashboard**  
  Visual dashboard for tracking confidence levels and progress across different skills.  
  https://chromewebstore.google.com/detail/bdeejnjepnebfohfioemjpjafogagihf/

- 🔍 **Phabricator Code Review Assistant**  
  Productivity extension designed to improve the Phabricator code review workflow.  
  https://chromewebstore.google.com/detail/bliejkiejeobjkejldieaefmjbgokiaf/
